            ...
            <div className="row">
                <div className="col-md-9">
                    <div className="jumbotron">
                        ...
                        <p className="about-paragraph">Hello, and welcome to my page! My name is Carlos Cantu, and I’m a Full-Stack Web Developer that is passionate about creating intuitive and user-friendly applications for the modern web.
                        I enjoy working with progressive front-end technologies like React and Sass, and am always eager to learn new tools to better UI experiences. 
                        </p>
                        <p className="about-paragraph">
                        Here you’ll find the projects I’ve worked on in the past and continue to build on. Most of the technologies used in these projects are crucial to building standard full-stack applications in today's web environment, and were utilized
                        in an efficient way. It's my hope that this page will showcase all the skills I've aquired and will continue build off of as I add more and more technologies under my belt.
                        </p>
                    </div>
                </div>
            </div>
